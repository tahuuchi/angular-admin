(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/cdk/bidi'),require('ng-zorro-antd/core/outlet'),require('@angular/common'),require('@angular/cdk/platform'),require('ng-zorro-antd/core/pipe'),exports, require('@angular/cdk/platform'), require('@angular/core'), require('rxjs'), require('@angular/cdk/bidi'), require('rxjs/operators'), require('@angular/common'), require('ng-zorro-antd/core/outlet'), require('ng-zorro-antd/core/pipe')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/statistic', ['@angular/core','@angular/cdk/bidi','ng-zorro-antd/core/outlet','@angular/common','@angular/cdk/platform','ng-zorro-antd/core/pipe','exports', '@angular/cdk/platform', '@angular/core', 'rxjs', '@angular/cdk/bidi', 'rxjs/operators', '@angular/common', 'ng-zorro-antd/core/outlet', 'ng-zorro-antd/core/pipe'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.cdk.bidi,global.ngZorroAntd.core.outlet,global.ng.common,global.ng.cdk.platform,global.ngZorroAntd.core.pipe,(global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].statistic = {}), global.ng.cdk.platform, global.ng.core, global.rxjs, global.ng.cdk.bidi, global.rxjs.operators, global.ng.common, global['ng-zorro-antd'].core.outlet, global['ng-zorro-antd'].core.pipe));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,ɵngcc5,exports, platform, core, rxjs, bidi, operators, common, outlet, pipe) { 
...
NzStatisticModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NzStatisticModule_Factory(t) { return new (t || NzStatisticModule)(); }, imports: [[bidi.BidiModule, common.CommonModule, platform.PlatformModule, outlet.NzOutletModule, pipe.NzPipesModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NzStatisticModule, { declarations: [NzStatisticComponent, NzCountdownComponent, NzStatisticNumberComponent], imports: [ɵngcc1.BidiModule, ɵngcc3.CommonModule, ɵngcc4.PlatformModule, ɵngcc2.NzOutletModule, ɵngcc5.NzPipesModule], exports: [NzStatisticComponent, NzCountdownComponent, NzStatisticNumberComponent] }); })();
