(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/platform-browser'),require('@angular/common'),exports, require('@angular/common'), require('@angular/core'), require('ng-zorro-antd/core/util'), require('@angular/platform-browser')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/pipes', ['@angular/core','@angular/platform-browser','@angular/common','exports', '@angular/common', '@angular/core', 'ng-zorro-antd/core/util', '@angular/platform-browser'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.platformBrowser,global.ng.common,(global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].pipes = {}), global.ng.common, global.ng.core, global['ng-zorro-antd'].core.util, global.ng.platformBrowser));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, common, core, util, platformBrowser) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var NzAggregatePipe = /** @class */ (function () {
        function NzAggregatePipe() {
        }
        NzAggregatePipe.prototype.transform = function (value, method) {
            ...
            switch (method) {
                ...
                case 'avg':
                    return util.sum(value) / value.length;
                case 'max':
                    return Math.max.apply(Math, __spread(value));
                case 'min':
                    return Math.min.apply(Math, __spread(value));
                default:
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzAggregatePipe, [{
     ...
     */
    var NzBytesPipe = /** @class */ (function () {
        function NzBytesPipe() {
        }
        NzBytesPipe.prototype.transform = function (input, decimal, from, to) {
            if (decimal === void 0) { decimal = 0; }
            if (from === void 0) { from = 'B'; }
            if (!(util.isNumberFinite(input) && util.isNumberFinite(decimal) && decimal % 1 === 0 && decimal >= 0)) {
                return input;
            }
            var bytes = input;
            var unit = from;
        ...
        NzBytesPipe.formatResult = function (result, unit) {
            return result + " " + unit;
        };
        NzBytesPipe.calculateResult = function (format, bytes) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzBytesPipe, [{
    ...
    var NzToCssUnitPipe = /** @class */ (function () {
        ...
        NzToCssUnitPipe.prototype.transform = function (value, defaultUnit) {
            ...
            var percentagesUnit = ['%'];
            var listOfUnit = __spread(absoluteLengthUnit, relativeLengthUnit, percentagesUnit);
            var unit = 'px';
            if (listOfUnit.some(function (u) { return u === defaultUnit; })) {
                unit = defaultUnit;
            }
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzToCssUnitPipe, [{
     ...
     * found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
     */
    var NzEllipsisPipe = /** @class */ (function () {
        function NzEllipsisPipe() {
        }
        NzEllipsisPipe.prototype.transform = function (value, length, suffix) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzEllipsisPipe, [{
     ...
     * found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
     */
    var NzSafeNullPipe = /** @class */ (function () {
        function NzSafeNullPipe() {
        }
        NzSafeNullPipe.prototype.transform = function (value, replace) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzSafeNullPipe, [{
     ...
     * found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
     */
    var NzSanitizerPipe = /** @class */ (function () {
        function NzSanitizerPipe(sanitizer) {
            this.sanitizer = sanitizer;
        }
        NzSanitizerPipe.prototype.transform = function (value, type) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzSanitizerPipe, [{
    ...
    NzSanitizerPipe.ctorParameters = function () { return [
     ...
     * found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
     */
    var NzTrimPipe = /** @class */ (function () {
        function NzTrimPipe() {
        }
        // TODO(chensimeng) trimEnd, trimStart
        NzTrimPipe.prototype.transform = function (text) {
            return text.trim();
        };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzTrimPipe, [{
        type: core.Pipe,
        args: [{
                name: 'nzTrim'
            }]
...
NzPipesModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NzPipesModule_Factory(t) { return new (t || NzPipesModule)(); }, imports: [[common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NzPipesModule, { declarations: [NzToCssUnitPipe, NzSafeNullPipe, NzSanitizerPipe, NzTrimPipe, NzBytesPipe, NzAggregatePipe, NzEllipsisPipe], imports: [ɵngcc2.CommonModule], exports: [NzToCssUnitPipe, NzSafeNullPipe, NzSanitizerPipe, NzTrimPipe, NzBytesPipe, NzAggregatePipe, NzEllipsisPipe] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzPipesModule, [{
    ...
    exports.NzAggregatePipe = NzAggregatePipe;
    exports.NzBytesPipe = NzBytesPipe;
    exports.NzEllipsisPipe = NzEllipsisPipe;
    exports.NzPipesModule = NzPipesModule;
    exports.NzSafeNullPipe = NzSafeNullPipe;
    exports.NzSanitizerPipe = NzSanitizerPipe;
    exports.NzToCssUnitPipe = NzToCssUnitPipe;
    exports.NzTrimPipe = NzTrimPipe;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=ng-zorro-antd-pipes.umd.js.map