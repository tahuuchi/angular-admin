(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('ng-zorro-antd/core/config'),require('@angular/cdk/bidi'),require('@angular/common'),require('@angular/cdk/observers'),exports, require('@angular/cdk/bidi'), require('@angular/core'), require('ng-zorro-antd/core/config'), require('ng-zorro-antd/core/util'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/observers'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/spin', ['@angular/core','ng-zorro-antd/core/config','@angular/cdk/bidi','@angular/common','@angular/cdk/observers','exports', '@angular/cdk/bidi', '@angular/core', 'ng-zorro-antd/core/config', 'ng-zorro-antd/core/util', 'rxjs', 'rxjs/operators', '@angular/cdk/observers', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ngZorroAntd.core.config,global.ng.cdk.bidi,global.ng.common,global.ng.cdk.observers,(global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].spin = {}), global.ng.cdk.bidi, global.ng.core, global['ng-zorro-antd'].core.config, global['ng-zorro-antd'].core.util, global.rxjs, global.rxjs.operators, global.ng.cdk.observers, global.ng.common));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,exports, bidi, core, config, util, rxjs, operators, observers, common) { 
    ...
    var NzSpinComponent = /** @class */ (function () {
        ...
        NzSpinComponent.prototype.ngOnInit = function () {
            ...
            var loading$ = this.delay$.pipe(operators.startWith(this.nzDelay), operators.distinctUntilChanged(), operators.switchMap(function (delay) {
                ...
                return _this.spinning$.pipe(operators.debounce(function (spinning) { return rxjs.timer(spinning ? delay : 0); }));
...
NzSpinModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NzSpinModule_Factory(t) { return new (t || NzSpinModule)(); }, imports: [[bidi.BidiModule, common.CommonModule, observers.ObserversModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NzSpinModule, { declarations: [NzSpinComponent], imports: [ɵngcc2.BidiModule, ɵngcc3.CommonModule, ɵngcc4.ObserversModule], exports: [NzSpinComponent] }); })();
