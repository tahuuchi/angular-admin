(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('ng-zorro-antd/core/config'),require('@angular/common'),require('@angular/cdk/bidi'),exports, require('@angular/cdk/bidi'), require('@angular/common'), require('@angular/core'), require('ng-zorro-antd/core/config'), require('ng-zorro-antd/core/logger'), require('ng-zorro-antd/core/util'), require('rxjs'), require('rxjs/operators')) :
  typeof define === 'function' && define.amd ? define('ng-zorro-antd/space', ['@angular/core','ng-zorro-antd/core/config','@angular/common','@angular/cdk/bidi','exports', '@angular/cdk/bidi', '@angular/common', '@angular/core', 'ng-zorro-antd/core/config', 'ng-zorro-antd/core/logger', 'ng-zorro-antd/core/util', 'rxjs', 'rxjs/operators'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ngZorroAntd.core.config,global.ng.common,global.ng.cdk.bidi,(global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].space = {}), global.ng.cdk.bidi, global.ng.common, global.ng.core, global['ng-zorro-antd'].core.config, global['ng-zorro-antd'].core.logger, global['ng-zorro-antd'].core.util, global.rxjs, global.rxjs.operators));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,exports, bidi, common, core, config, logger, util, rxjs, operators) { 
var _c0 = ["*"];
...
function NzSpaceComponent_ng_template_1_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    var last_r2 = ctx_r6.last;
    var index_r3 = ctx_r6.index;
...
'use strict';
   ...
   */
  var NzSpaceItemLegacyComponent = /** @class */ (function () {
      function NzSpaceItemLegacyComponent(renderer, elementRef) {
          this.renderer = renderer;
          this.elementRef = elementRef;
      }
      NzSpaceItemLegacyComponent.prototype.setDirectionAndSize = function (direction, size) {
      ...
      NzSpaceItemLegacyComponent.prototype.ngOnInit = function () { };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzSpaceItemLegacyComponent, [{
      ...
      return NzSpaceItemLegacyComponent;
  }());
  NzSpaceItemLegacyComponent.ctorParameters = function () { return [
      { type: core.Renderer2 },
   ...
   * found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
   */
  var NzSpaceItemDirective = /** @class */ (function () {
      function NzSpaceItemDirective() {
      }
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzSpaceItemDirective, [{
  ...
  NzSpaceItemDirective.ctorParameters = function () { return []; };
  ...
  ***************************************************************************** */
  ...
  var NzSpaceComponent = /** @class */ (function () {
      function NzSpaceComponent(nzConfigService, cdr) {
      ...
      NzSpaceComponent.prototype.updateSpaceItems = function () {
          var _this = this;
          var _a;
          var numberSize = typeof this.nzSize === 'string' ? SPACE_SIZE[this.nzSize] : this.nzSize;
          this.spaceSize = numberSize / (!!this.nzSplit ? 2 : 1);
          if ((_a = this.nzSpaceItemComponents) === null || _a === void 0 ? void 0 : _a.length) {
              logger.warnDeprecation('`nz-space-item` in `nz-space` will be removed in 12.0.0, please use `*nzSpaceItem` instead.');
              this.nzSpaceItemComponents.forEach(function (item) {
                  item.setDirectionAndSize(_this.nzDirection, _this.spaceSize);
              });
          }
          this.cdr.markForCheck();
      };
      NzSpaceComponent.prototype.ngOnChanges = function () {
          this.updateSpaceItems();
          this.mergedAlign = this.nzAlign === undefined && this.nzDirection === 'horizontal' ? 'center' : this.nzAlign;
      };
      NzSpaceComponent.prototype.ngOnDestroy = function () {
          this.destroy$.next();
          this.destroy$.complete();
      };
      NzSpaceComponent.prototype.ngAfterContentInit = function () {
          var _this = this;
          this.updateSpaceItems();
          this.nzSpaceItemComponents.changes.pipe(operators.takeUntil(this.destroy$)).subscribe(function () {
...
NzSpaceComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NzSpaceComponent, selectors: [["nz-space"], ["", "nz-space", ""]], contentQueries: function NzSpaceComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵcontentQuery(dirIndex, NzSpaceItemDirective, false, core.TemplateRef);
    } if (rf & 2) {
        var _t;
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzSpaceComponent, [{
        ...
        args: [{
            ...
            type: core.ContentChildren,
            args: [NzSpaceItemDirective, { read: core.TemplateRef }]
        }] }); })();
  ...
  NzSpaceComponent.propDecorators = {
      ...
      nzWrap: [{ type: core.Input }],
      nzSize: [{ type: core.Input }],
      nzSpaceItemComponents: [{ type: core.ContentChildren, args: [NzSpaceItemLegacyComponent,] }],
      items: [{ type: core.ContentChildren, args: [NzSpaceItemDirective, { read: core.TemplateRef },] }]
  };
  __decorate([
      util.InputBoolean(),
...
NzSpaceModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NzSpaceModule_Factory(t) { return new (t || NzSpaceModule)(); }, imports: [[bidi.BidiModule, common.CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NzSpaceModule, { declarations: [NzSpaceComponent, NzSpaceItemLegacyComponent, NzSpaceItemDirective], imports: [ɵngcc3.BidiModule, ɵngcc2.CommonModule], exports: [NzSpaceComponent, NzSpaceItemLegacyComponent, NzSpaceItemDirective] }); })();
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzSpaceModule, [{
  ...
  exports.NzSpaceComponent = NzSpaceComponent;
  exports.NzSpaceItemDirective = NzSpaceItemDirective;
  exports.NzSpaceItemLegacyComponent = NzSpaceItemLegacyComponent;
  exports.NzSpaceModule = NzSpaceModule;

  Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=ng-zorro-antd-space.umd.js.map