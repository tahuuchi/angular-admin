...
'use strict';
    ...
    ***************************************************************************** */
    ...
    var NzButtonComponent = /** @class */ (function () {
        ...
        NzButtonComponent.prototype.insertSpan = function (nodes, renderer) {
        ...
        NzButtonComponent.prototype.assertIconOnly = function (element, renderer) {
        ...
        NzButtonComponent.prototype.ngAfterContentInit = function () {
            var _this = this;
            this.loading$
                .pipe(operators.startWith(this.nzLoading), operators.filter(function () { return !!_this.nzIconDirectiveElement; }), operators.takeUntil(this.destroy$))
...
NzButtonComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NzButtonComponent, selectors: [["button", "nz-button", ""], ["a", "nz-button", ""]], contentQueries: function NzButtonComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, icon.NzIconDirective, true, core.ElementRef);
    } if (rf & 2) {
        var _t;
...
NzButtonModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function NzButtonModule_Factory(t) { return new (t || NzButtonModule)(); }, imports: [[bidi.BidiModule, common.CommonModule, wave.NzWaveModule, icon.NzIconModule, transitionPatch.ɵNzTransitionPatchModule], ɵngcc5.ɵNzTransitionPatchModule, ɵngcc6.NzWaveModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NzButtonModule, { declarations: [NzButtonComponent, NzButtonGroupComponent], imports: [ɵngcc2.BidiModule, ɵngcc3.CommonModule, ɵngcc6.NzWaveModule, ɵngcc4.NzIconModule, ɵngcc5.ɵNzTransitionPatchModule], exports: [NzButtonComponent, NzButtonGroupComponent, ɵngcc5.ɵNzTransitionPatchModule, ɵngcc6.NzWaveModule] }); })();
