(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('ng-zorro-antd/core/config'),require('ng-zorro-antd/i18n'),require('@angular/cdk/platform'),require('@angular/cdk/bidi'),require('@angular/forms'),require('ng-zorro-antd/core/outlet'),require('@angular/common'),require('@angular/cdk/overlay'),require('ng-zorro-antd/core/overlay'),require('ng-zorro-antd/icon'),require('ng-zorro-antd/core/transition-patch'),require('ng-zorro-antd/button'),require('ng-zorro-antd/core/wave'),exports, require('@angular/cdk/bidi'), require('@angular/cdk/overlay'), require('@angular/cdk/platform'), require('@angular/core'), require('@angular/forms'), require('date-fns'), require('ng-zorro-antd/core/animation'), require('ng-zorro-antd/core/config'), require('ng-zorro-antd/core/logger'), require('ng-zorro-antd/core/util'), require('ng-zorro-antd/i18n'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('ng-zorro-antd/button'), require('ng-zorro-antd/core/outlet'), require('ng-zorro-antd/core/overlay'), require('ng-zorro-antd/icon'), require('ng-zorro-antd/core/polyfill')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/time-picker', ['@angular/core','ng-zorro-antd/core/config','ng-zorro-antd/i18n','@angular/cdk/platform','@angular/cdk/bidi','@angular/forms','ng-zorro-antd/core/outlet','@angular/common','@angular/cdk/overlay','ng-zorro-antd/core/overlay','ng-zorro-antd/icon','ng-zorro-antd/core/transition-patch','ng-zorro-antd/button','ng-zorro-antd/core/wave','exports', '@angular/cdk/bidi', '@angular/cdk/overlay', '@angular/cdk/platform', '@angular/core', '@angular/forms', 'date-fns', 'ng-zorro-antd/core/animation', 'ng-zorro-antd/core/config', 'ng-zorro-antd/core/logger', 'ng-zorro-antd/core/util', 'ng-zorro-antd/i18n', 'rxjs', 'rxjs/operators', '@angular/common', 'ng-zorro-antd/button', 'ng-zorro-antd/core/outlet', 'ng-zorro-antd/core/overlay', 'ng-zorro-antd/icon', 'ng-zorro-antd/core/polyfill'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ngZorroAntd.core.config,global.ngZorroAntd.i18n,global.ng.cdk.platform,global.ng.cdk.bidi,global.ng.forms,global.ngZorroAntd.core.outlet,global.ng.common,global.ng.cdk.overlay,global.ngZorroAntd.core.overlay,global.ngZorroAntd.icon,global.ngZorroAntd.core.transitionPatch,global.ngZorroAntd.button,global.ngZorroAntd.core.wave,(global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd']['time-picker'] = {}), global.ng.cdk.bidi, global.ng.cdk.overlay, global.ng.cdk.platform, global.ng.core, global.ng.forms, global.dateFns, global['ng-zorro-antd'].core.animation, global['ng-zorro-antd'].core.config, global['ng-zorro-antd'].core.logger, global['ng-zorro-antd'].core.util, global['ng-zorro-antd'].i18n, global.rxjs, global.rxjs.operators, global.ng.common, global['ng-zorro-antd'].button, global['ng-zorro-antd'].core.outlet, global['ng-zorro-antd'].core.overlay, global['ng-zorro-antd'].icon, global['ng-zorro-antd'].core.polyfill));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,ɵngcc5,ɵngcc6,ɵngcc7,ɵngcc8,ɵngcc9,ɵngcc10,ɵngcc11,ɵngcc12,ɵngcc13,exports, bidi, overlay, platform, core, forms, dateFns, animation, config, logger, util, i18n, rxjs, operators, common, button, outlet, overlay$1, icon, polyfill) { 
...
function NzTimePickerPanelComponent_div_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function NzTimePickerPanelComponent_div_6_Template_button_click_8_listener() { ɵngcc0.ɵɵrestoreView(_r41); var ctx_r42 = ɵngcc0.ɵɵnextContext(); return ctx_r42.onClickOk(); });
    ɵngcc0.ɵɵtext(9);
...
NzTimePickerComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NzTimePickerComponent, selectors: [["nz-time-picker"]], viewQuery: function NzTimePickerComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: function () { return [ɵngcc5.DefaultValueAccessor, ɵngcc5.NgControlStatus, ɵngcc5.NgModel, ɵngcc6.NzStringTemplateOutletDirective, ɵngcc7.NgIf, ɵngcc8.CdkConnectedOverlay, ɵngcc9.NzConnectedOverlayDirective, ɵngcc10.NzIconDirective, ɵngcc11.ɵNzTransitionPatchDirective, NzTimePickerPanelComponent, ɵngcc7.NgClass]; }, pipes: function () { return [ɵngcc7.AsyncPipe]; }, encapsulation: 2, data: { animation: [animation.slideMotion] }, changeDetection: 0 });
...
NzTimePickerPanelComponent.ɵfac = function NzTimePickerPanelComponent_Factory(t) { return new (t || NzTimePickerPanelComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.DateHelperService), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
NzTimePickerPanelComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NzTimePickerPanelComponent, selectors: [["nz-time-picker-panel"]], viewQuery: function NzTimePickerPanelComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("ngIf", !ctx.nzInDatePicker);
    } }, directives: [ɵngcc7.NgIf, ɵngcc7.NgForOf, ɵngcc12.NzButtonComponent, ɵngcc13.NzWaveDirective, ɵngcc11.ɵNzTransitionPatchDirective, ɵngcc7.NgTemplateOutlet], pipes: [ɵngcc7.DecimalPipe, ɵngcc2.NzI18nPipe], encapsulation: 2, changeDetection: 0 });
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(NzTimePickerPanelComponent, [{
    ...
    }], function () { return [{ type: ɵngcc0.ChangeDetectorRef }, { type: ɵngcc2.DateHelperService }, { type: ɵngcc0.ElementRef }]; }, { nzInDatePicker: [{
            type: core.Input
        }], nzHideDisabledOptions: [{
            type: core.Input
        }], nzUse12Hours: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(NzTimePickerModule, { declarations: [NzTimePickerComponent, NzTimePickerPanelComponent], imports: [ɵngcc4.BidiModule, ɵngcc7.CommonModule, ɵngcc5.FormsModule, ɵngcc2.NzI18nModule, ɵngcc8.OverlayModule, ɵngcc10.NzIconModule, ɵngcc9.NzOverlayModule, ɵngcc6.NzOutletModule, ɵngcc12.NzButtonModule], exports: [NzTimePickerPanelComponent, NzTimePickerComponent] }); })();
